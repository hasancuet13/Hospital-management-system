...
<div class="w3-row">
	...
	<div class="w3-col" style="width:20%"><a href="#" class="w3-hover-black"><b style="color:#00a38c;display: inline-block;">MANAGE MEDICINE</b></a></div>
	</div>
</div>

<div style="margin-left:120px;margin-right:200px;background:white;height:70%;">
	<div style="margin-left:50px;margin-right:50px;	">
	 <h5 style="font-family:times new roman;text-align:center;font-size:35;margin-top:5px;"><b>Notice Upload</b></h5>
	<form action="upload.php" method="POST" enctype="multipart/form-data">
		<input type="file" name="file" style="background:gray;color:white;margin-left:210px;margin-top:20px;"/>
		<button class="w3-hover-green" style="width:100px;" type="submit" name="btn-upload">upload</button>
	</form>
	
	<?php
		if(isset($_GET["success"])){
			echo "<script type='text/javascript'>$.notify('Successfully file uploaded...','success')</script>";
		}
		else if(isset($_GET["fail"])){
			echo "<script type='text/javascript'>$.notify('Fail to file upload...','warn')</script>";
		}
		
	?>
	<table style="margin-left:100px;width:80%;background:#95c28d;">
