...
<div class="w3-row">
	...
	<div class="w3-col" style="width:22%">
		<div class="w3-dropdown-hover">
		<a class="w3-hover-white" href="Testmanage.php" style="color:#00a38c;"><b style="color:#00a38c;display: inline-block;">MANAGE TEST</b></a>
			<div class="w3-dropdown-content w3-hover">
				<button onclick="window.open('http://localhost/code/Project/Testmanage.php')" class="w3-btn w3-hover-red" style="width:100%;">Blood Test</button>
...
<div class="w3-row">
  ...
  <img src="pic2.jpg" width="100%" height="20%">
  
  </div>
  <div class="w3-col w3-white w3-container" style="width:20%">
  <br><br>
  <img src="pic2.jpg" width="100%" height="20%" class="w3-border w3-round-xlarge"><br><br><br>
  <img src="pic1.jpg" width="100%" height="20%" class="w3-border w3-round-xlarge"><br><br>
  </div>
