...
<div class="main_menu">
		<div class="w3-row">
			...
			<div class="w3-col" style="width:15%"><a href="Contactus1.php"><b style="color:#00a38c;">CONTACT US</b></a></div>
...
<div class="w3-row">
	...
	<div class="w3-dropdown-hover">
		<a class="w3-hover-white" style="color:#00a38c;"><b style="color:#00a38c;display: inline-block;">MANAGE TEST</b></a>
			<div class="w3-dropdown-content w3-hover">
				<button onclick="window.open('Testmanage1.php')" class="w3-btn w3-hover-red" style="width:100%;">Blood Test</button>
				<button class="w3-btn w3-hover-red" style="width:100%;">X-ray</button>
				<button class="w3-btn w3-hover-red" style="width:100%;">Ultrasound</button>
				<button class="w3-btn w3-hover-red" style="width:100%;">CT Scan</button>
				<button class="w3-btn w3-hover-red" style="width:100%;">Thyroid Scan</button>
				<button class="w3-btn w3-hover-red" style="width:100%;">Urin Test</button>
				<button class="w3-btn w3-hover-red" style="width:100%;">ECG</button>
				<button class="w3-btn w3-hover-red" style="width:100%;">MRI</button>
...
<div class="section_two" style="padding: 0px 0px 45px 0px;margin-top:-2px;">
<div class="w3-row">
  <div class="w3-col w3-container" style="width:30%;">
  <h4>HOSPITAL MANAGEMENT</h4>
  <img src="pic1.jpg" width="100%" height="20%">
  <h4>TEST MANAGEMENT</h4>
  <img src="photo/testmanage.jpg" width="100%" height="20%">
  <h4>PATIENT MANAGEMENT</h4>
  <img src="photo/patientmanage.jpg" width="100%" height="20%">
  
  </div>
  <div class="w3-col w3-white w3-container" style="width:20%">
  <br><br>
  <img src="photo/patientmanage1.jpg" width="100%" height="20%" class="w3-border w3-round-xlarge"><br><br><br>
  <img src="photo/medicinemanage.jpg" width="100%" height="20%" class="w3-border w3-round-xlarge"><br><br><br>
  <img src="photo/doctormanage.jpg" width="100%" height="20%" class="w3-border w3-round-xlarge"><br><br>
  </div>
  <div class="w3-col w3-white w3-container" style="width:50%">
  <h3 style="color: #008080;margin-top:30px;"><b>PATIENT MANAGEMENT</b></h3>
  <p class="w3-panel w3-blue w3-round-xlarge" style="font-family: Times New Roman;font-size: 15px; color: blue">Today people are accutomed to accessing meaningful informatin from of huge array of sources.The reality is that workplace learing happens continuously in lots of different ways.</p>
  <h3 style="color: #008080;margin-top:35px;"><b>MEDICINE MANAGEMENT</b></h3>
    <p class="w3-panel w3-blue w3-round-xlarge" style="font-family: Times New Roman;font-size: 15px; color: blue">Today people are accutomed to accessing meaningful informatin from of huge array of sources.The reality is that workplace learing happens continuously in lots of different ways.</p>
  <h3 style="color: #008080;margin-top:35px;"><b>DOCTOR MANAGEMENT</b></h3>
    <p class="w3-panel w3-blue w3-round-xlarge" style="font-family: Times New Roman;font-size: 16px; color: blue">Today people are accutomed to accessing meaningful informatin from of huge array of sources.The reality is that workplace learing happens continuously in lots of different ways.</p>
  </div>  
 </div>
</div>
